...
#define SOURCEWITH	2560
#define SOURCEHIGH	1440
#define DEPTH		1
...
int CameraWith[3] = {2560,1920,640};//30 350 130
int CameraHigh[3] = {1440,1080,480};//30 350 130
...
JNIEXPORT jint JNICALL Java_com_sykean_SyA83_VideoGain(JNIEnv *env, jobject obj,jint index,jint adc)
{
	...
	switch(adc)
	{
		...
		default:
			V4l2_SetParams((void*)CameraHandle[index],index,adc);
			break;
	}
#endif
	return -1;

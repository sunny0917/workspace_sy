...
int YV12ToBGR24_Table(unsigned char* pYUV,unsigned char* pBGR32,int width,int height)
{
	...
	for (j = strip-4;j >= 0;j -=4){
		...
		bgr[4] = yData[y2Idex] + rdif;		//red
		bgr[5] = yData[y2Idex] - invgdif;	//geed
		bgr[6] = (yData[y2Idex] + bdif);	//b
		bgr[7] = 0xFF;						//alpa
		//bgr[3] = yData[y2Idex] + rdif;		//rad
		//bgr[4] = yData[y2Idex] - invgdif;	//geed
		//bgr[5] = (yData[y2Idex] + bdif);	//b			
            for (k = 0;k < 8;k++){
...
int YV12ToBGR24_Table(unsigned char* pYUV,unsigned char* pBGR32,int width,int height)
{
	...
	//0123 4567
		...
		bgr[0] = yData[yIdx];//yData[yIdx] + rdif;		//red
		bgr[1] = yData[yIdx];//yData[yIdx] - invgdif;		//geed
		bgr[2] = yData[yIdx];//(yData[yIdx] + bdif);		//b
		bgr[3] = 0xFF;						//alpa

		bgr[4] = yData[y2Idex];//yData[y2Idex] + rdif;		//red
		bgr[5] = yData[y2Idex];//yData[y2Idex] - invgdif;	//geed
		bgr[6] = yData[y2Idex];//(yData[y2Idex] + bdif);	//b
		bgr[7] = 0xFF;						//alpa
		//bgr[3] = yData[y2Idex] + rdif;		//rad
		//bgr[4] = yData[y2Idex] - invgdif;	//geed
		//bgr[5] = (yData[y2Idex] + bdif);	//b			

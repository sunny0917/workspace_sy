...
public class MainActivity extends Activity {
    ...
    protected void onResume() {
        ...
        haveframeone = 2;
        haveframetwo = 2;
        mBitmap = Bitmap.createBitmap(576, 360, Bitmap.Config.ARGB_8888);//720P
        frame = new byte[2304*1440];
        Irisframe = new byte[1920*1080];
        Irisbackframe = new byte[1920*1080];


        saveframe = new byte[2304*1440];
                    ...
                    if(camerastatus == true){
                        ...
                        if(ret==0)
                        {
                            ...
                            if(showjin == 0) {
                                ...
                                ret = iris.RatioImage(frame, mBitmap, 0);
